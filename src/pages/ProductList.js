...
const ProductList = () => {
    ...
    const columns = [
        ...
        //     selector: row => row.installation_method,
        // },
        {
            name: 'SKU',
        ...
        // },
        // {
        //     name: 'Upload Pictures / Files',
        //     selector: row => row.productPictures,
        // },
        {
            ...
            <nav aria-label="Page navigation example">
                <ul className="pagination justify-content-end mt-4">
                    ...
                    {Array.from({ length: 5 }).map((_, index) => (
                        ...
                        >
                            <button
                                className="page-link num-click mx-1 mt-2"
                                style={{
                                    borderRadius: 60,

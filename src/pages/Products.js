    ...
    <div  >
      ...
      <form class="row g-3 pt-3 shadow p-3 mb-5" style={{ padding: 20, backgroundColor: "#f7f6ed" }} onSubmit={Validation}>
        ...
        <div class="col-md-2">
          ...
          {/* {errors.name && data.colour.length <= 0 ? (
            <p
              className="text-danger"
              style={{ fontSize: "14px" }}
            >
        ...
        <div class="col-md-12 text-center" style={{ marginTop: 40 }}>
          {
            id ? (<>
              <button type="" class="btn btn-primary fw-bold shadow border-0 p-2" style={{ backgroundColor: "#e67929", width: 150, height: 50 }} onClick={(e) => { handleFormSubmit(e); updateFormData(e); }}>Update </button>
            </>) : (<>
              <button type="" class="btn btn-primary fw-bold shadow border-0 p-2" style={{ backgroundColor: "#e67929", width: 150, height: 50 }} onClick={(e) => { handleFormSubmit(e); }}>Submit</button>
            </>)
          }
        </div>
